...
<head>
    ...
    <style>
        @page { margin: 0; }
        html, body { background: #11111d; color: #e5e7eb; }
        body { font-family: DejaVu Sans, Arial, sans-serif; font-size: 12px; margin: 0; padding: 28px 32px; }
        .page-bg { position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: #11111d; z-index: -1; }
        .header { width: 100%; margin-bottom: 18px; }
        .header td { vertical-align: top; border: 0; }
        .title { font-size: 26px; font-weight: 700; margin: 0; color: #f9fafb; }
        .muted { color: #9ca3af; }
        .section { margin-top: 18px; }
        .section-title { font-size: 14px; font-weight: 700; margin-bottom: 8px; color: #f9fafb; }
        table { width: 100%; border-collapse: collapse; }
        th, td { padding: 8px; border-bottom: 1px solid #32324a; text-align: left; color: #e5e7eb; }
        th { background: #171725; font-weight: 700; color: #f3f4f6; }
        .billing-grid td { width: 50%; vertical-align: top; border: 0; padding-left: 0; padding-right: 0; background: transparent; }
        .billing-grid td:last-child { text-align: right; }
        .billing-title { font-size: 13px; font-weight: 700; margin-bottom: 6px; color: #93c5fd; }
        .billing-block { line-height: 1.5; }
        .status-text { font-size: 12px; font-weight: 600; color: #93c5fd; }
        .right { text-align: right; }
        .totals td { border: 0; padding: 4px 0; }
        .totals .label { color: #9ca3af; }
        .totals .value { text-align: right; }
        .grand-total { font-size: 15px; font-weight: 700; color: #f9fafb; border-top: 1px solid #32324a; padding-top: 8px; }
        .grand-total td { color: #f9fafb; border-top: 1px solid #32324a; }
    </style>
</head>
<body bgcolor="#11111d">
